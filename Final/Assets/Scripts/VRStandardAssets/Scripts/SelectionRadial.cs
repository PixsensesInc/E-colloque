...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionRadial : MonoBehaviour
    {
        ...
        [SerializeField] private VRInteractiveItem m_InteractiveItem;                           // Reference to the VRInput so that input events can be subscribed to.


        private Coroutine m_SelectionFillRoutine;                                               // Used to start and stop the filling coroutine based on input.
        private bool m_IsSelectionRadialActive=true;                                                    // Whether or not the bar is currently useable.
